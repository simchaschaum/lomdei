...
const PlatformServices = () => {
    ...
    const getData = async () => {
        if(isMounted.current){
            ...
            const docRef = doc(db, "website-info", "platform-services");
            ...
            <section>
                <div className="text-pic-side">
                    ...
                    <div className="tps-pic">
                        <img src="../../pictures/Platform/platform-pic (1).jpg" alt="Students Learn with the Lomdei Platform" />
                    </div>
                </div>
                <div className="text-pic-side">
                    <div className="tps-txt">
                    ...
                    <div className="tps-pic">
                        <img src="../../pictures/Platform/platform-pic (2).jpeg" alt="Students Learn with the Lomdei Platform" />
                    </div>
                </div>
            </section>
